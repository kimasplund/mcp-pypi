...
aiohttp = ">=3.8.0"
    ...
    try:
        ...
        pypi_mcp_server.client.check_requirements_file = AsyncMock(
        ...
        pypi_mcp_server.client.check_requirements_file.assert_called_once_with(
            pyproject_path
        )
...
async def test_check_requirements_file_format_option(pypi_mcp_server):
    ...
    try:
        ...
        result = await pypi_mcp_server.check_requirements_file(
            requirements_path, format="json"
        )
